...
const UpgradeInfo: React.FC<{
  ...
  const upgrade = buildingUpgrades[building].find(
    (upgrade) => upgrade[0] === currentUpgrade,
  );
  ...
  return (
    <>
      {buildingUpgrades[building].map((upgrade) => (
        <NavLink
          key={upgrade[0]}
          to={`/buildings/${building}/${upgrade[0]}`}
          style={linkStyle}
        >
          <NavButton
...
const BuildingsButtons: React.FC<{ selectedBuilding: Building | null }> = ({
  selectedBuilding,
}) => {
  return (
    <>
    ...
    <div className="building-presentation">
      ...
      <div className="building-description">
        <img
          ...
          alt="Informations about the building"
        />
      </div>
...
export const Buildings = () => {
  ...
  const foundUpgrade = buildingUpgrades[building].find(
    (upgrade) => upgrade[0] === currentUpgrade,
  );
  ...
  return (
    <div>
      ...
      <div className="building-presentation">
        ...
        <div className="little-box-buildings building-use">
          <img
            src={`/assets/${usageList[buildingList[building][4]][1]}.png`}
            alt="Usage"
          />
          <div>
            <h3>Usage</h3>
