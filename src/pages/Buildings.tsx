...
import "../css/shared/containers.css"
...
const UpgradeList: React.FC<{
    ...
    if (buildingUpgrades[building].length === 0)
        return (
            <>
                <NavButton icon="misc/upgrade" name="Upgrade" size={0.8} selected={false} wiggle={false}
                           visible={false}/>
...
const EmptyBuilding: React.FC = () => (
    <div>
        <div className="list-container-2-cols">
        ...
        <div>
            ...
            <div className="building-presentation">
                <div className="building-title">
                    ...
                    <img className="building-image" src={`/assets/buildings/${building}.png`}
