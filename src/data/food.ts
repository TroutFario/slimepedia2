...
export const foodDescription: { [key in Food]: string } = {
  ...
  [Food.Lettuce]: "The only glass of water with your daily dose of fiber!",
  [Food.Beet]: "If you listen to it closely, you can faintly hear a veggie.",
  [Food.Tater]: "Who knew spuds could break the sound barrier?",
  [Food.Onion]: "I wouldn't trust this onion, even less so than a normal onion.",
  [Food.Pogo]: "The most common fruit found on the Range, and some say, the most delicious.",
  [Food.Cuberry]: "Delicate, sweet, and they never roll off the table.",
  [Food.Mango]: "Intensely sweet with a cool, minty finish.",
  [Food.Granite]: "Rich in minerals!",
  [Food.Pear]: "This is a fruit that knows how to fight back.",
  [Food.Cherry]: "Sharply sour or sickeningly sweet.",
  [Food.Chick]: "So little and soft you'd think they're filled with marshmallow.",
  [Food.ChickBriar]: "A breed of chick that's totally bush-league.",
  [Food.ChickCandied]: "The sweetest chicks grow into the toughest jawbreakers.",
  [Food.ChickCluck]: "The king of chickens has to start somewhere.",
  [Food.ChickPainted]: "A tiny chick that's hiding a bounty of colorful potential.",
  [Food.ChickSea]: "Equal parts salt and fluff.",
  [Food.ChickStony]: "This little chick had quite a hard upbringing.",
  [Food.Hen]: "A hearty chicken bred to be twice as tasty as its cousin on Earth.",
  [Food.HenStony]: "Has a rock solid conviction... in chicken stuff.",
  [Food.HenBriar]: "A real wild bird that loves to ramble in the bramble.",
  [Food.HenPainted]: "Some believe it's what lies at the end of a rainbow. Totally disappointing.",
  [Food.HenCandied]: "Try to catch them before the sugar rush.",
  [Food.HenSea]: "Loveable trash. Like your favorite bad movie.",
  [Food.HenCluck]: "A chicken that's always ready to throw down.",
  [Food.Rooster]: "Struts his stuff like he's king of the coop.",
  [Food.HenElder]: "An old bird whose egg-laying days are over, easy.",
  [Food.RoosterElder]: "Shakes his tail feathers and no one cares.",
  [Food.Nectar]: "Very sweet but VERY sticky. Handle with care.",
  [Food.Water]: "Give your slimes a bath, they really need it.",
  [Food.Ash]: "",
