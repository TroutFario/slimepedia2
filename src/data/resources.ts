...
const cRP = (name: string, description: string, spawn: MixedRegion[]) => ({name, description, spawn});

export const resourceList: { [key in Resource]: FoodProps } = {
    [Resource.Primordy]: cRP("Primordy Oil", "This stuff is pre-pre-prehistoric.", [Region.Valley]),
    [Resource.Brine]: cRP("Deep Brine", "Salt of the earth kind of stuff.", [Ranch.Conservatory, Region.Fields]),
    [Resource.Sand]: cRP(
        "Silky Sand",
        "The finest, smoothest sand you'll ever see. Rubbish for sand castles.",
        [Region.Strand, Region.Valley],
    ),
    [Resource.Lava]: cRP("Lava Dust", "A survey on the state of this matter answered 'undecided'.", [Region.Valley]),
    [Resource.Wax]: cRP(
        "Buzz Wax",
    ...
    [Resource.Radiant]: cRP(
        "Radiant Ore",
        "The awesome power of a rainbow and the sleek aesthetic of a lump of mineral.",
        [Region.Strand, Region.Valley],
    ),
    [Resource.Diamond]: cRP(
        "Strange Diamond",
        "Very strange, but even more valuable.",
        [Region.Fields, Region.Strand, Region.Valley, Region.Bluffs, Region.Labyrinth],
    ),
    [Resource.Fossil]: cRP("Slime Fossil", "If history could smile, it would look like this.", [Region.Bluffs]),
    [Resource.Snowflake]: cRP("Perfect Snowflake", "They made all other snowflakes feel jealous.", [Region.Bluffs]),
    [Resource.Sunsap]: cRP("Sun Sap", "So beautiful that staring at it too long will hurt your eyes.", [Region.Bluffs]),
    [Resource.Mote]: cRP("Lightning Mote", "A scintillating speck of storm.", [Weather.Lightning]),
    [Resource.Glass]: cRP("Storm Glass", "When the sky welds the earth.", [Weather.Lightning]),
    [Resource.Drift]: cRP("Drift Crystal", "Drifting away on the wind.", [Weather.Wind]),
    [Resource.Magma]: cRP("Magma Comb", "A new level of spicy honey.", [Region.Labyrinth]),
    [Resource.Aqua]: cRP("Aqua Glass", "A different kind of hard water.", [Region.Labyrinth]),
    [Resource.Dream]: cRP("Dream Bubble", "Dream a little dream.", [Region.Labyrinth]),
    [Resource.Petal]: cRP("Tin Petal", "Nature is metal.", [Region.Labyrinth]),
    [Resource.Indigo]: cRP("Black Indigonium", "Dark as midnight.", [Region.Labyrinth]),
    [Resource.Royal]: cRP(
        "Royal Jelly",
        "The king of all jellies... that is, until you meet the queen.",
        [Region.Labyrinth],
    ),
    [Resource.Snowball]: cRP("Snowball", "Slime-approved way to have fun and chill out.", [Region.Bluffs]),
    [Resource.UnstableResources]: cRP(
        "Unstable Resources",
        "Unnatural objects with a slippery grasp on reality.",
        [Region.Labyrinth],
    ),
    [Resource.Prisma]: cRP("Radiant Plort", "Prismatic plorts of possibilities with a purpose.", [Region.Labyrinth]),
    [Resource.Sprinkles]: cRP("Sprinkles", "Sweet to have, but not for eating!", [Ranch.Sanctuary])
};
