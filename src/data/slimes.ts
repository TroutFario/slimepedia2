...
export const slimesList: {
  ...
  [Slime.Honey]: ["Honey Slime", FoodType.Fruits, Food.Mango, true, Toy.Bee],
  ...
  [Slime.Crystal]: ["Crystal Slime", FoodType.Veggies, Food.Onion, true, Toy.Crystalball],
  [Slime.Fire]: ["Fire Slime", FoodType.Ash, Food.Ash, false, Toy.Charcoal],
  [Slime.Saber]: ["Saber Slime", FoodType.Meat, Food.HenCluck, true, Toy.Stego],
  [Slime.Shadow]: ["Shadow Slime", null, null, false, null],
  [Slime.Twin]: ["Twin Slime", FoodType.Fruits, Food.Cherry, true, Toy.Spinner],
  [Slime.Hyper]: ["Hyper Slime", FoodType.Veggies, Food.Tater, true, Toy.Rocket],
  [Slime.Sloomber]: ["Sloomber Slime", FoodType.Meat, Food.HenCandied, true, Toy.Sheep],
  [Slime.Dervish]: ["Dervish Slime", FoodType.Fruits, Food.Pear, true, Toy.Gyro],
  [Slime.Tangle]: ["Tangle Slime", FoodType.Meat, Food.HenPainted, true, Toy.Sol],
  [Slime.Yolky]: ["Yolky Slime", null, null, false, Toy.Bread],
